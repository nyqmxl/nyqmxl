...
#define LED_GPIO1            42  //configure LED pin
#define LED_GPIO2            46  //configure LED pin
#define MOTORS_GPIO1            4  //configure LED pin
#define MOTORS_GPIO2            5  //configure LED pin
#define MOTORS_GPIO3            40  //configure LED pin
#define MOTORS_GPIO4            41  //configure LED pin
...
//#if CONFIG_LED_ILLUMINATOR_ENABLED
  ...
  analogWrite(LED_GPIO1, led_duty);
  analogWrite(LED_GPIO2, led_duty);
  analogWrite(MOTORS_GPIO1, led_duty);
  analogWrite(MOTORS_GPIO2, led_duty);
  analogWrite(MOTORS_GPIO3, led_duty);
  analogWrite(MOTORS_GPIO4, led_duty);
  }
//#endif
  else {
